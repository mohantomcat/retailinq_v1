...
@Service
@Slf4j
public class PollerRuntimeConfigService {

    private final JdbcTemplate checkpointJdbcTemplate;

    public PollerRuntimeConfigService(@Qualifier("checkpointJdbcTemplate") JdbcTemplate checkpointJdbcTemplate) {
        this.checkpointJdbcTemplate = checkpointJdbcTemplate;
    }
    ...
    private String findOverride(String key) {
        try {
            return checkpointJdbcTemplate.query(
