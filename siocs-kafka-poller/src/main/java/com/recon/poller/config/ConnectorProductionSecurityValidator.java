...
public class ConnectorProductionSecurityValidator implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        required(failures, "spring.datasource.password", "SIOCS_DB_PASSWORD");
        required(failures, "checkpoint.datasource.password", "PG_PASSWORD");
        required(failures, "connector.security.password", "CONNECTOR_ADMIN_PASSWORD");
