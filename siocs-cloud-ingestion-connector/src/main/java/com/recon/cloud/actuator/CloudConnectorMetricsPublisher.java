...
public class CloudConnectorMetricsPublisher {
    ...
    @Scheduled(fixedDelayString =
            "${cloud.connector.metrics-refresh-interval-ms:60000}")
    public void refresh() {
        try {
    ...
    private void registerStatusGauge(String status) {
        ...
        Gauge.builder("cloud.connector.ingestion.status.count", gauge, AtomicLong::get)
