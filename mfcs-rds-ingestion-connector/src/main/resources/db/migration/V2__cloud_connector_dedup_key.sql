ALTER TABLE recon.mfcs_ingestion_transaction
...
DROP INDEX IF EXISTS recon.ux_mfcs_ingestion_txn_business;

CREATE UNIQUE INDEX IF NOT EXISTS ux_mfcs_ingestion_txn_dedup
    ON recon.mfcs_ingestion_transaction (dedup_key);
